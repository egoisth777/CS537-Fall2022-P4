 ...
 */
int
MFS_write(int nbytes, int offset, int inum, inode_t * inode_table, char * data_bitmap, char * inode_bitmap, char * buffer, super_t * superBlock, void * image){
    // precheck
...
int main(int argc, char const *argv[])
{
    ...
    while (1)
    {
        ...
        else if (strcmp(msg, "MFS_Write") == 0)
        {
            ...
            int res = MFS_write(nbytes, offset, inum, inode_table, data_bitmap, inode_bitmap, buffer, superBlock, image);
